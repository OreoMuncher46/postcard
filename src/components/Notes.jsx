        ...
        {NOTES.map((n) => (
          <div key={n.n} className="notes__slide" style={{ position: "relative", borderBottom: "1px solid var(--hair)" }}>
            ...
            <div className="notes__visual">
              <div className="img-mask img-square img--noir">
